      ...
      <Container>
        ...
        <Row className="justify-content-md-center">
          ...
          <Col xs={6} md={4}>
            ...
            <p class="text-justify">Bringing Taka into my life in the midst of COVID-19 was one of the biggest changes I have ever experienced in my life. Just learning to be 100% responsible for the wellbeing of another creature is an enormous thing. One that I am always so impressed others handle with such grace. But besides being a typical puppy with typical puppy antics, Taka is one of many "pandemic puppies" with separation anxiety. Because I spend a <b>lot</b> of time at home, I thought it would be fun to brush up on my technical skills and try my hand at building a personal website. Tadah!</p>
          </Col>
        </Row>
      </Container>
    );
